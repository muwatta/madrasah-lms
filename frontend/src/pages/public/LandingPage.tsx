...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 antialiased" dir={dir}>
      ...
      <section ref={featuresRef} id="features" className="bg-gray-50 dark:bg-gray-800/50 border-y border-gray-200 dark:border-gray-700 py-20 transition-all duration-700 delay-300" style={{ opacity: featuresVisible ? 1 : 0, transform: featuresVisible ? 'translateY(0)' : 'translateY(20px)' }}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="inline-block px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-xs font-semibold uppercase tracking-wider">
      ...
      <footer className="bg-gray-900 dark:bg-black text-gray-400 border-t border-gray-800 dark:border-gray-950">
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div><h4 className="text-white font-semibold text-sm mb-4">{t('landing.footerPlatform')}</h4><ul className="space-y-2.5 text-sm"><li><a href="/#features" className="hover:text-white transition-colors">{t('landing.footerFeatures')}</a></li><li><Link to="/pricing" className="hover:text-white transition-colors">{t('landing.footerPricing')}</Link></li><li><Link to="/docs" className="hover:text-white transition-colors">{t('landing.footerDocumentation')}</Link></li><li><Link to="/about" className="hover:text-white transition-colors">{t('landing.footerAbout')}</Link></li><li><Link to="/blog" className="hover:text-white transition-colors">{t('landing.footerBlog')}</Link></li></ul></div>
          <div><h4 className="text-white font-semibold text-sm mb-4">{t('landing.footerSupport')}</h4><ul className="space-y-2.5 text-sm"><li><Link to="/faq" className="hover:text-white transition-colors">{t('landing.footerFAQ')}</Link></li><li><Link to="/help" className="hover:text-white transition-colors">{t('landing.footerHelpCenter')}</Link></li><li><Link to="/contact" className="hover:text-white transition-colors">{t('landing.footerContactUs')}</Link></li><li><Link to="/community" className="hover:text-white transition-colors">{t('landing.footerCommunity')}</Link></li></ul></div>
